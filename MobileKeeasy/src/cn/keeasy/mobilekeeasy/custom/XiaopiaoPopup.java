...
public class XiaopiaoPopup extends PopupWindow {
	...
	public XiaopiaoPopup(Context context) {
		super(context);
		this.contxt = context;
	...
	public void showPopup(View parent, final Handler handler,
		...
		xp_btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (xp_name.getText().length() < 1) {
				...
				} else if (Sources.CURRENTSHOP.bAccount.equals(spp.getString(
						"account", ""))) {
					...
					if (spp.getBoolean("islogin", false)) {
						...
						addmod.mGetAddOrderUrlByCount(
								...
								7, spp.getString("userName", ""), xp_name
	...
	public void setTextInfo() {
		...
		dis = Sources.CURRENTSHOP.dayType.get(Sources.CURRENTSHOP.item).discount;
