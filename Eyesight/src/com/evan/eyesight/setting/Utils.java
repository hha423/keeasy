	...
	public static void drawEye_E(Canvas canvas, Paint paint, int i, float f,
		...
		if (flag)
			...
			default:
				...
				if (flag1)
					canvas.drawRect(f + f2, f1 + 2.0F * f2, f + 5F * f2, f1
							+ 3F * f2, paint);
				canvas.drawRect(f + f2, f1 + 4F * f2, f + 5F * f2,
						f1 + 5F * f2, paint);
				break;
			...
			case 2: // '\002'
				...
				if (flag1)
					canvas.drawRect(f + 2.0F * f2, f1 + f2, f + 3F * f2, f1
							+ 5F * f2, paint);
				canvas.drawRect(f + 4F * f2, f1 + f2, f + 5F * f2,
						f1 + 5F * f2, paint);
				break;
			...
			default:
				...
				if (flag1)
					canvas.drawRect(f + f2, f1 - 3F * f2, f + 5F * f2, f1
							- 2.0F * f2, paint);
				canvas.drawRect(f + f2, f1 - 5F * f2, f + 5F * f2,
						f1 - 4F * f2, paint);
				break;
			...
			case 0: // '\0'
				...
				if (flag1)
					canvas.drawRect(f + 2.0F * f2, f1 - 5F * f2, f + 3F * f2,
							f1 - f2, paint);
				canvas.drawRect(f + 4F * f2, f1 - 5F * f2, f + 5F * f2,
						f1 - f2, paint);
				break;
			...
			case 2: // '\002'
				...
				if (flag1)
					canvas.drawRect(f + 2.0F * f2, f1 - 4F * f2, f + 3F * f2,
							f1, paint);
